...
router.get('/cities', async (req, res) => {
    try {
        // Aggregate listings by city field instead of location, filtering out invalid cities
...
router.get('/cities/popular', async (req, res) => {
    try {
        // Get the cities data directly using city field, filtering out invalid cities
        const cityStats = await Listing.aggregate([
            {
                $match: {
                    city: { $exists: true, $ne: null, $ne: '', $ne: 'Unknown' }
...
router.get('/overview', async (req, res) => {
    try {
        ...
        // Get unique cities count using city field, filtering out invalid cities
